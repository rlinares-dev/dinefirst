// Seed en CommonJS para evitar problemas de ESM con ts-node
// Ejecutado vía "prisma db seed"
...
async function main() {
  ...
  await prisma.reservation.upsert({
    where: { confirmationCode: "DEMO-1234" },
    update: {},
    create: {
      userId: diner.id,
      restaurantId: restaurant.id,
  ...
  console.log("Seed completado con datos demo (CommonJS).");
}
